    ...
    <div class="section section-about-us">
      <div class="container">
        ...
        <div class="section-story-overview">
          <div class="row">
            <div class="col-md-6">
              <div class="image-container image-left" style="background-image: url(<?php echo base_url('assets/img/login.jpg') ?>)">
              ...
              <div class="image-container" style="background-image: url(<?php echo base_url('assets/img/bg3.jpg') ?>)"></div>
            </div>
            <div class="col-md-5">
              <!-- First image on the right side, above the article -->
              <div class="image-container image-right" style="background-image: url('<?php echo base_url('assets/img/bg1.jpg') ?>')"></div>
